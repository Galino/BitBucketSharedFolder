...
-- privileges
GRANT ALL ON xklcom00."Customer" TO xgalbi01;
GRANT ALL ON xklcom00."Delivery_Area" TO xgalbi01;
...
CREATE MATERIALIZED VIEW LOG ON xklcom00."Delivery_Area" WITH ROWID;
CREATE MATERIALIZED VIEW LOG ON xklcom00."Customer" WITH ROWID;

-- tento pohlad treba vytvorit pod uctom xgalbi01
